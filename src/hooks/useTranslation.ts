...
const translations: Record<string, Record<string, string>> = {
  'EN': {
    ...
    'returns': 'Returns',
    'orders': '& Orders',
    'top_drops': 'Premium Picks',
    'cart': 'Cart',
    'deal_alerts_title': 'Sign up for Deal Alerts',
    'deal_alerts_desc': "Don't miss out on exclusive stock drops and premium products.",
    'subscribe': 'Subscribe',
  ...
  'FR': {
    ...
    'returns': 'Retours',
    'orders': '& Commandes',
    'top_drops': 'Sélection Premium',
    'cart': 'Panier',
    'deal_alerts_title': 'Inscrivez-vous aux alertes promos',
    'deal_alerts_desc': 'Ne manquez pas les offres exclusives et les produits premium.',
    'subscribe': "S'abonner",
  ...
  'ES': {
    ...
    'orders': 'y Pedidos',
    'top_drops': 'Selección Premium',
    'cart': 'Carrito',
    'deal_alerts_title': 'Regístrate para Alertas de Ofertas',
    'deal_alerts_desc': 'No te pierdas de stock exclusivo y productos premium.',
  ...
  'DE': {
    ...
    'orders': '& Bestellungen',
    'top_drops': 'Premium-Auswahl',
    'cart': 'Einkaufswagen',
    'deal_alerts_title': 'Für Angebotsalarme anmelden',
    'deal_alerts_desc': 'Verpassen Sie keine exklusiven Produkte.',
  ...
  'UR': {
    ...
    'returns': 'واپسی',
    'orders': '& آرڈرز',
    'top_drops': 'پریمیم پکس',
    'cart': 'کارٹ',
    'deal_alerts_title': 'ڈیل الرٹس کے لئے سائن اپ کریں',
    'deal_alerts_desc': 'خصوصی مصنوعات اور ڈراپس مت چھوڑیں۔',
    'subscribe': 'سبسکرائب',
